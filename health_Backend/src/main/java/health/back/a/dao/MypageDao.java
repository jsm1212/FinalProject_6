...
//	public List<> getMyRoutine(String nick); // 운동 루틴
	public List<WorkBbsDto> getMyBbs(String nick);	   // 내 게시글 목록
	public List<WorkReplyDto> getMyReply(String nick); // 내 댓글 목록
	public List<WorkBbsDto> getMyLike(String nick);	   // 좋아요 누른 글 목록	
}